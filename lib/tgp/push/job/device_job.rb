...
module Tgp::Push
  class DeviceJob < Tgp::Async::BaseJob
    ...
    def self.async_message(device_id, message=nil, badge_count=nil, sound=nil, content_available=false, expire_time=nil, default_message=nil, user_data=nil)
      expire_time_i = nil
      ...
      push(:device_id => device_id, :message => message, :badge_count => badge_count, :sound => sound, :content_available => content_available, 
    ...
    def self.perform(msg)
      ...
      device.message(message, badge_count, sound, content_available, expire_time, default_message, user_data)
    end
  end
end
